...
from fairseq_code.data_utils import compute_block_mask_1d, get_buckets, get_bucketed_sizes
from fairseq_code.audio_utils import (
    parse_path,
    read_from_stored_zip,
    is_sf_audio_data,
)
from fairseq_code.text_compressor import TextCompressor
